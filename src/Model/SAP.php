    ...
    class SAP extends Util {
        ...
        protected function setPoItem($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_poi ( objky, 
                                                ebeln, 
                                                ebelp, 
                                                loekz, 
                                                aedat, 
        ...
        protected function setPoSline($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_pos ( objky, 
                                                ebeln,
                                                ebelp,
                                                etenr,
                                                eindt,
        ...
        protected function setShipment($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_shp(  objky,
                                                tknum,
                                                vbtyp,
                                                shtyp,
                                                tplst,
        ...
        protected function setDelivery($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_ibd(  objky,
                                                vbeln,
                                                posnr,
                                                ernam,
                                                erdat,
        ...
        protected function setGoodsMvt($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_mvt(  objky,
                                                mblnr, 
                                                mjahr,
                                                zeile,
                                                bwart,
        ...
        protected function setInvoice($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO data_inv(  objky,
                                                bukrs,
                                                belnr,
                                                gjahr,
                                                buzei,
        ...
        protected function setSubstock($rqst) {
            ...
            foreach($rqst->items as $item) {
                ...
                $sqls = "INSERT INTO sc_stock(  objky,
                                                matnr, 
                                                werks,
                                                charg,
                                                sobkz,
